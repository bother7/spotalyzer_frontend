...
class App extends Component {
  ...
  componentDidMount() {
    if (localStorage.getItem('jwt_token') !== null && this.props.username === "" && this.props.location.pathname !== "/callback" && this.props.location.pathname !== "/demo") {
